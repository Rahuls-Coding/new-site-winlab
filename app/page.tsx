        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button asChild className="bg-white text-black hover:bg-gray-200 px-8 py-3 text-base font-medium">
                <Link href="/timeline">
                  View Timeline
              ...
              <Button
                variant="outline"
                asChild
                className="border-none text-white hover:bg-gray-900 px-8 py-3 text-base"
              >
      ...
      <section className="py-20 px-4 relative">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-transparent border-none transition-all duration-300">
              <CardContent className="p-8">
                <div className="mb-6">
                  <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-4">
                    <CpuChipIcon className="h-6 w-6 text-blue-400" />
                  </div>
                  <h3 className="text-xl font-medium text-white mb-3">Performance Benchmarking</h3>
                </div>
            ...
            <Card className="bg-transparent border-none transition-all duration-300">
              <CardContent className="p-8">
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-medium text-white mb-3">Latency Optimization</h3>
                </div>
                <p className="text-gray-400 leading-relaxed">
            ...
            <Card className="bg-transparent border-none transition-all duration-300">
              <CardContent className="p-8">
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-medium text-white mb-3">Resource Management</h3>
                </div>
                <p className="text-gray-400 leading-relaxed">
      ...
      <section className="py-20 px-4 relative">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Card className="bg-transparent border-none hover:bg-gray-900/50 transition-all duration-300">
              <CardContent className="p-0">
                ...
                >
                  ...
                  <ArrowRightIcon className="w-4 h-4 text-gray-400 group-hover:text-white transition-colors transform rotate-45" />
                </Link>
              </CardContent>
            </Card>
